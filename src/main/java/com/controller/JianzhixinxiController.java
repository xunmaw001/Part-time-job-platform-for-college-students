...
public class JianzhixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JianzhixinxiEntity jianzhixinxi, 
		...
		if(tableName.equals("qiye")) {
			jianzhixinxi.setQiyezhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R vote(@PathVariable("id") String id,String type){
        JianzhixinxiEntity jianzhixinxi = jianzhixinxiService.selectById(id);
        if(type.equals("1")) {
        	jianzhixinxi.setThumbsupnum(jianzhixinxi.getThumbsupnum()+1);
        } else {
        	jianzhixinxi.setCrazilynum(jianzhixinxi.getCrazilynum()+1);
        }
        jianzhixinxiService.updateById(jianzhixinxi);
        return R.ok("投票成功");
    }
