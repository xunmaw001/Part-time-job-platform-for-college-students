...
public class XueshengliuyanController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengliuyanEntity xueshengliuyan, 
		...
		if(tableName.equals("daxuesheng")) {
			xueshengliuyan.setZhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("qiye")) {
			xueshengliuyan.setQiyezhanghao((String)request.getSession().getAttribute("username"));
		}
