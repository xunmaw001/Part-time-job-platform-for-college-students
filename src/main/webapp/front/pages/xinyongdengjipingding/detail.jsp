				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.pingdingliyou"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				data: {
					...
					buynumber: 1,
					// 当前详情页表
					detailTable: 'xinyongdengjipingding',
					// 评价列表
					dataList: [],
					// 选座座位列表
					numberList: []
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xinyongdengjipingding`);
