        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="jianzhileixing" id="jianzhileixing" placeholder="兼职类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('jianzhixinxi','新增')" @click="jump('../jianzhixinxi/add.jsp')" type="button" class="layui-btn btn-theme">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jianzhileixing').val()) {
          param['jianzhileixing'] = jquery('#jianzhileixing').val() ? '%' + jquery('#jianzhileixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('jianzhixinxi/list', 'get', param, function(res) {
