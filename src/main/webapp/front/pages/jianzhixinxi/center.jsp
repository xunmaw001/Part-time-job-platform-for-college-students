				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="gangweiyaoqiu" id="gangweiyaoqiu" placeholder="岗位要求" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">岗位工资</label>
							<div class="layui-input-block">
								<input type="text" name="gangweigongzi" id="gangweigongzi" placeholder="岗位工资" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">兼职类型</label>
							<div class="layui-input-block">
								<select name="jianzhileixing" id="jianzhileixing">
							...
							<div class="layui-input-block">
								<input type="text" name="gongzuoshijian" id="gongzuoshijian" placeholder="工作时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
