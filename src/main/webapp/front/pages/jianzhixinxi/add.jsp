		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.gangweigongzi" type="text" name="gangweigongzi" id="gangweigongzi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">兼职类型</label>
                        <div class="layui-input-block">
                            <select name="jianzhileixing" id="jianzhileixing" lay-filter="jianzhileixing">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in jianzhileixing" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.gongzuoshijian" type="text" name="gongzuoshijian" id="gongzuoshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="gangweijieshao" id="gangweijieshao">请输入岗位介绍</textarea>
						</div>
					</div>
				...
				var tupianUpload = upload.render({
                    ...
                    images_upload_handler: function(blobInfo, succFun, failFun) {
                        ...
                        xhr.send(formData);
																																...
																																vue.jianzhileixing = '日结兼职,周末兼职'.split(',')
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                                    					                                                                                                                                                                					...
                                                                                                                                                                                    					                                                                                                                                                                					var gangweijieshao = tinymce.get('#gangweijieshao').getContent()
					data.gangweijieshao = gangweijieshao;
										                                                                                                                                                                					                                                                                                                                                                					                    if(!data.gangweigongzi){
                        layer.msg('岗位工资不能为空', {
							time: 2000,
							icon: 5
						});
                        return false
                                                            ...
                                                            if(!isIntNumer(data.gangweigongzi)){
                        layer.msg('岗位工资应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('jianzhixinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
