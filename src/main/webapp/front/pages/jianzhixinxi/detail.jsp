				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>岗位工资：</span>
							<span class="desc">
								{{detail.gangweigongzi}}
							</span>
						</div>
																								<div class="detail-item">
							<span>兼职类型：</span>
							<span class="desc">
								{{detail.jianzhileixing}}
							</span>
						</div>
																								<div class="detail-item">
							<span>工作地点：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('jianzhixinxi','投递简历')" @click="onAcrossTap('toudijianli')" type="button" class="layui-btn">
								投递简历
							</button>
																					<button v-if="isAuth('jianzhixinxi','学生留言')" @click="onAcrossTap('xueshengliuyan')" type="button" class="layui-btn">
								学生留言
							</button>
