    ...
    <div class="plate">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in qiyeList" v-bind:key="index">
                <a target="_self" :href="'../qiye/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.qiyetupian?item.qiyetupian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in qiuzhijianliList" v-bind:key="index">
                <a target="_self" :href="'../qiuzhijianli/detail.jsp?id='+item.id">
                  <div class="posi-img">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in jianzhixinxiList" v-bind:key="index">
                <a target="_self" :href="'../jianzhixinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`qiye/list`, 'get', {
        ...
        vue.qiyeList = res.data.list;
      });
      http.request(`qiuzhijianli/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.qiuzhijianliList = res.data.list;
      });
      http.request(`jianzhixinxi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.jianzhixinxiList = res.data.list;
      });
    });
  </script>
</body>
