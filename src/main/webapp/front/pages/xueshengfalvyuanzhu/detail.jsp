				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>提交资料：</span>
							<span class="desc">
								<a download="tijiaoziliao" :href="detail.tijiaoziliao">点击下载</a>
							</span>
						</div>
		...
		<script>
			var vue = new Vue({
				...
				data: {
					...
					buynumber: 1,
					// 当前详情页表
					detailTable: 'xueshengfalvyuanzhu',
					// 评价列表
					dataList: [],
					// 选座座位列表
					numberList: []
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xueshengfalvyuanzhu`);
