		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑求职简历</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑求职简历</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">求职简历信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学历</label>
										<input id="xueli" name="xueli" class="form-control" placeholder="学历">
									</div>
									<div class="form-group col-md-6">
										<label>专业</label>
									...
									<div class="form-group col-md-6">
										<label>求职岗位</label>
										<input id="qiuzhigangwei" name="qiuzhigangwei" class="form-control" placeholder="求职岗位">
									</div>
									<div class="form-group col-md-6">
										<label>工作地点</label>
									...
									<div class="form-group col-md-6">
										<label>期望薪资</label>
										<input id="qiwangxinzi" name="qiwangxinzi" class="form-control" placeholder="期望薪资">
									</div>
									<div class="form-group col-md-6">
										<label>教育背景</label>
										<input id="jiaoyubeijing" name="jiaoyubeijing" class="form-control" placeholder="教育背景">
									</div>
									<div class="form-group col-md-6">
										<label>获奖证书</label>
										<input id="huojiangzhengshu" name="huojiangzhengshu" class="form-control" placeholder="获奖证书">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qiuzhijianli/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("qiuzhijianli/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function dataBind(){
			...
			$("#xueli").val(ruleForm.xueli);	
			$("#zhuanye").val(ruleForm.zhuanye);	
			$("#xingbie").val(ruleForm.xingbie);	
			$("#chushengriqi-input").val(ruleForm.chushengriqi);
			$("#qiuzhigangwei").val(ruleForm.qiuzhigangwei);	
			$("#gongzuodidian").val(ruleForm.gongzuodidian);	
			$("#qiwangxinzi").val(ruleForm.qiwangxinzi);	
			$("#jiaoyubeijing").val(ruleForm.jiaoyubeijing);	
			$("#huojiangzhengshu").val(ruleForm.huojiangzhengshu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.qiuzhigangwei != null && res.data.qiuzhigangwei != ''){

					$("#qiuzhigangwei").val(res.data.qiuzhigangwei);
					}
					if(res.data != null && res.data != '' && res.data.gongzuodidian != null && res.data.gongzuodidian != ''){

					$("#gongzuodidian").val(res.data.gongzuodidian);
					}
					if(res.data != null && res.data != '' && res.data.qiwangxinzi != null && res.data.qiwangxinzi != ''){

					$("#qiwangxinzi").val(res.data.qiwangxinzi);
					}
					if(res.data != null && res.data != '' && res.data.jiaoyubeijing != null && res.data.jiaoyubeijing != ''){

					$("#jiaoyubeijing").val(res.data.jiaoyubeijing);
					}
					if(res.data != null && res.data != '' && res.data.huojiangzhengshu != null && res.data.huojiangzhengshu != ''){

					$("#huojiangzhengshu").val(res.data.huojiangzhengshu);
					}
