						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="qiuzhigangwei" name="qiuzhigangwei" class="form-control" v-model="ruleForm.qiuzhigangwei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>工作地点</label>
									...
									<input id="qiwangxinzi" name="qiwangxinzi" class="form-control" v-model="ruleForm.qiwangxinzi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>教育背景</label>

									<input id="jiaoyubeijing" name="jiaoyubeijing" class="form-control" v-model="ruleForm.jiaoyubeijing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>获奖证书</label>

									<input id="huojiangzhengshu" name="huojiangzhengshu" class="form-control" v-model="ruleForm.huojiangzhengshu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>是否审核</label>
