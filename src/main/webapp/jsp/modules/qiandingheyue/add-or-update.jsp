		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑签订合约</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑签订合约</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">签订合约信息</h3>
	...
	<script>
		...
		var crossRuleForm = {};
			...
			function zhanghaoSelect2(){
				http("option/daxuesheng/zhanghao","GET",{
			...
			function zhanghaoSelect2Change(){
				...
				http("follow/daxuesheng/zhanghao","GET",{
					tableName: "daxuesheng",
					columnName: "zhanghao",
					columnValue: colVal
				},(res)=>{
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qiandingheyue/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("qiandingheyue/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
