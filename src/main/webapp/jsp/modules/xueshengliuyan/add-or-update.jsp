		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑学生留言</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑学生留言</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生留言信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>留言</label>
										<input id="liuyan" name="liuyan" class="form-control" placeholder="留言">
									</div>
									<div class="form-group col-md-6">
										<label>留言时间</label>
										<div id="liuyanshijianDate" class="input-append date form_datetime">
											<input id="liuyanshijian-input" name="liuyanshijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xueshengliuyan/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("xueshengliuyan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.liuyan != null && res.data.liuyan != ''){

					$("#liuyan").val(res.data.liuyan);
					}
