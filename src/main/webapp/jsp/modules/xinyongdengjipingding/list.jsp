...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">信用等级评定管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>信用等级评定列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">信用等级评定列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('qiyedengji')">企业等级<i id="qiyedengjiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('pingdingshijian')">评定时间<i id="pingdingshijianIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
        ...
        function getDataList() {
			http("xinyongdengjipingding/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
		...
		function setDataRow(item,number){
			...
			var qiyedengjiCell  = document.createElement('td');

						  qiyedengjiCell.innerHTML = item.qiyedengji; 

			row.appendChild(qiyedengjiCell);
			var pingdingliyouCell  = document.createElement('td');

			
			var pingdingshijianCell  = document.createElement('td');

						  pingdingshijianCell.innerHTML = item.pingdingshijian;


			row.appendChild(pingdingshijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xinyongdengjipingding/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xinyongdengjipingding");
