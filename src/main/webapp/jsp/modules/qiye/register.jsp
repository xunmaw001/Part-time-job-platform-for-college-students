		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="qiyedizhi" placeholder="企业地址" class="form-control-i">
																								...
																								<div class="form-group">
							<label class="label">企业规模</label> 
							<input type="text" name="qiyeguimo" placeholder="企业规模" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">负责人</label> 
							<input type="text" name="fuzeren" placeholder="负责人" class="form-control-i">
							</div>
																								<div class="form-group">
